...
def main():
    ...
    if args.task == 'concepts':
        ...
        # # def     do_the_thing_better(model, tokenizer, prompts, key, filename, num_plots=3):
            ...
            do_the_thing_BIG(model, tokenizer, con_prompts, key, filename, 3, num_mats=50, batch_sz=15)
        ...
        do_the_thing_BIG(model, tokenizer, law_prompts, key, filename, 3, num_mats=50, batch_sz=15)
        ...
        do_the_thing_BIG(model, tokenizer, code_prompts, key, filename, 3, num_mats=50, batch_sz=15)
